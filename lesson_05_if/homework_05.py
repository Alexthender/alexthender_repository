...
if operation == "+":
    print(f"Розв'язок: {num1} + {num2} = {num1 + num2}")
elif operation == "-":
    print(f"Розв'язок: {num1} - {num2} = {num1 - num2}")
else:
    print("Невідома операція! Використайте тільки цифри та + або -")
...
print(f"Кількість голосних у введеному вами тексті: {count}")
...
# Початок реалізації:
alien_color = input("Колір прибульця, якого збили: (green, yellow, red): ")
if alien_color == "green":
    ...
    print("Такого прибульця не збивали ще! Використайте тільки green, yellow або red.")
...
while True:
    ...
    if pizza_topping.lower() == "quit":
        print("Завершення вибору начинок для піци.")
        break
    else:
        print(f"Додано {pizza_topping} до вашої піци!")
...
print(f"Цифри у зворотному порядку: {reversed_number}")
...
max_number = None
while True:
    num = float(input("Введіть число (або 0 для завершення): "))
    if num == 0:
        break
